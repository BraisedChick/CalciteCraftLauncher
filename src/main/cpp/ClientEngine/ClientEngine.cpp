...
void ClientEngine::registerHandlers() {
    ...
    // Bundle Packet (1.19+, 跳过)
#if PROTOCOL_VERSION >= 762
    reg(0x00, &ClientEngine::handlePlayerStatus);
#endif
...
#else
    reg(0x03, &ClientEngine::handleEntity);
#endif
#endif
